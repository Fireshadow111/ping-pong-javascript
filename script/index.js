...
let keys = {};
let gameState = 0; // 0: initial, 1: running, 2: idle, 3: win, 4:over
...
let player1 = new Box({ /*player paddle*/
    x: 20,
...
let player2 = new Box({ /*player paddle*/
...
function createNewBall(){
    ...
    let g = Math.floor((Math.random() * 2) ) * 2;
    s = (s == 0 ? -3 : s);
    g = (g == 0 ? -3 : g);
    theBall.speed = s;
    theBall.gravity = g;
